...
class OrderShipmentAgent:
    ...
    async def investigate(
        ...
        *, case_id: str,
        ...
        result.order_details = context.order_details
        result.products = context.products
        result.shipments = context.shipments
        result.evidence = context.evidence
        result.investigation_notes = context.investigation_notes
        result.damaged_shipment_ids = context.damaged_shipment_ids
        trace.emit(
            case_id=case_id, event_type="handoff", actor="order_shipment_agent",
